package pl.edu.vistula.secondproject.product.service;
...
import pl.edu.vistula.secondproject.product.repository.ProductRepository;
import pl.edu.vistula.secondproject.product.support.ProductExceptionSupplier;
import pl.edu.vistula.secondproject.product.support.ProductMapper;
...
public class ProductService {
    ...
    public ProductResponse update(UpdateProductRequest updateProductRequest) {
        Product product = productRepository.findById(updateProductRequest.getId())
                .orElseThrow(ProductExceptionSupplier.productNotFound(updateProductRequest.getId()));
